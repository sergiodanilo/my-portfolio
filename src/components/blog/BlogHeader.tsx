      ...
      <div className="container position-relative">
        <div className="media flex-column flex-md-row">
          <StaticImage
            ...
            className="profile-medium mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto"
            alt="Profile"
          />
          <div className="media-body align-self-center">
            <h2 className="page-heading mb-2">Sérgio Holanda's Blog</h2>
            <div className="page-heading-tagline mb-3">
