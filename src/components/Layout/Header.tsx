        ...
        <div className="container-fluid">
          ...
          <nav className="navbar navbar-expand-lg navbar-dark position-relative">
            ...
            <ul className="social-list list-inline mb-0">
              <li className="list-inline-item"><a className="text-white" href="#">
            ...
            <div className="collapse navbar-collapse text-uppercase" id="navigation">
              <ul className="navbar-nav ml-lg-auto">
                ...
                <li className="nav-item dropdown mr-0">
                  <a className="nav-link dropdown-toggle" href="#" id="navigationLink" data-toggle="dropdown"
                     aria-haspopup="true" aria-expanded="false">
                    Pages
                  </a>
                  <div className="dropdown-menu dropdown-menu-right text-capitalize shadow-lg"
              ...
              <span id="slide-line" style={{width: '61.9062px', left: '1060.36px'}} />
            </div>
          </nav>
        </div>
      </div>
